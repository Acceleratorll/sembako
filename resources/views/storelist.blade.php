    ...
    <div class="container">
        <div id="rcorners1">
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Masukkan slogan" class="form-control" id="slogan" name="slogan" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="Masukkan wallet" class="form-control" id="wallet" name="wallet" required>
            </div>
            <div class="form-group">
                <label for="e-mail">E-mail</label>
                <input type="text" placeholder="Masukkan E-mail" class="form-control" id="e-mail" name="e-mail" required>
            </div>
            <div class="form-group">
